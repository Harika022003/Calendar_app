...
<th className="px-6 py-3 text-left">LinkedIn Profile</th>
...
<td className="px-6 py-4">{company.name}</td><td className="px-6 py-4">{company.location}</td>
<td className="px-6 py-4">{company.linkedinProfile}</td>
<td className="px-6 py-4">{company.email}</td>{/* Location Cell */}
<td className="px-6 py-4">{company.phoneNumber}</td><td className="px-6 py-4">{company.comments}</td>
