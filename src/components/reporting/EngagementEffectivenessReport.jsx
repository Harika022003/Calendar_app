...
const EngagementEffectivenessReport = () => {
  ...
  <InputLabel
    sx={{
      color: '#764ABC', // Purple color for the label
    }}
  >
    Company
  </InputLabel>
  <Select
    ...
    sx={{
      color: company ? '#764ABC' : 'inherit', // Purple color for selected value
      '.MuiOutlinedInput-notchedOutline': {
        borderColor: '#764ABC', // Purple border color
      },
      '&:hover .MuiOutlinedInput-notchedOutline': {
        borderColor: '#764ABC', // Purple border color on hover
      },
      '&.Mui-focused .MuiOutlinedInput-notchedOutline': {
        borderColor: '#764ABC', // Purple border color when focused
      },
    }}
  >
    <MenuItem value="">
    ...
    {companies.map((comp) => (
      <MenuItem
        ...
        value={comp}
        sx={{
          color: '#764ABC', // Purple color for the item in the menu
        }}
      >
        {comp}
      </MenuItem>
        ...
        <Button variant="contained" sx={{ backgroundColor: '#764ABC', color: '#FFFFFF' }} onClick={() => {}}>Filter</Button>
        <Button variant="outlined" sx={{ backgroundColor: '#764ABC', color: '#FFFFFF' }} onClick={handleExportCSV}>Export CSV</Button>
        <Button variant="outlined" sx={{ backgroundColor: '#764ABC', color: '#FFFFFF' }} onClick={handleExportPDF}>Export PDF</Button>
      </Box>
